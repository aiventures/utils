...
class Tablizer():
    ...
    def __init__(self,f:str,skip_blank_lines:bool=False,comment_marker:str="^#",strip_lines:bool=False) -> None:
    ...
    def _read_lines(self)->None:
        """ reading lines """
        _lines_dict = Persistence.read_txt_file(filepath=self._file,comment_marker=None,
                                                skip_blank_lines=self._skip_blank,
                                                strip_lines=self._strip_lines,with_line_nums=True)
    ...
    def bundle_by_marker(self,marker:str=None,include_marker_line:bool=True,sep:str=None,ignorecase:bool=True,as_dict:bool=False)->list|dict:
