"""Emoji Code Dict, that can be created using emoji_util.EmojiUtil.save_emoji_dict(...)
The Codes can be transformed into emojis by using emoji_util.EmojiUtil.unicode2emoji(...)
"""

# rendered with all characters
EMOJI_DICT_CODES = {
...
# Rendered with only 1st Character
EMOJI_DICT_CHARS = {
    "grinning face": "😀",
