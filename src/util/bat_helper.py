...
class BatHelper():
    ...
    def create_env_file(self,key:str,value:str=None,p:str=None,prefix:str="_tmp",quotes:bool=True)->str|None:
    ...
    def save_env_file(self,p:str=None,filename:str="_envs.bat",prefix:str="_tmp",quotes:bool=True)->str|None:
