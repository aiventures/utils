...
#    type Literal['data_definition']
    ...
    env : Optional[Dict[str,Any]] = None   # setting up default environment values (eg Date Format, separator, others ...)
...
class ConfigItemType(RootModel):
    """ Config Item Model """
    root : Annotated[Union[Annotated[ConfigItem,Tag("config_item")],
