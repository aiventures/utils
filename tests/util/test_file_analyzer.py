...
def test_file_analyzer_all_diifferent_rule_types(
    fixture_testpath, fixture_ruledict_filename_path, fixture_ruledict_filename_lorem
):
...
def test_find_all_diifferent_rule_types(
    fixture_testpath, fixture_ruledict_filename_path, fixture_ruledict_filename_lorem
):
